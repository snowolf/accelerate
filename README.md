...
-->
### Change Log by Shishuai

Add a notebook about how to run accelerate on Amazon SageMaker, check here [sagemaker-training-hf-accelerate](./examples/sagemaker-training-hf-accelerate.ipynb).
